...
public class Seg {
	...
	Seg(int psx, int psy, int pdx, int pdy, int cl, int cc) {
		...
		col = new Paint();
		switch (part2) {
		case 0: col.setARGB(255,val1, 20, 20); break;
		case 1: col.setARGB(255,20, val1, 20); break;
		case 2: col.setARGB(255,20, 20, val1); break;
		case 3: col.setARGB(255,val1, val1, 20); break;
		case 4: col.setARGB(255,20, val1, val1); break;
		case 5: col.setARGB(255,val1, 20, val1); break;
		default: col.setARGB(255,20, 20, 20); break;
		}
	}
	...
	void storeSeg(Document doc, Element mazeXML, int number, int i) {
		...
		MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number+ "_" + i, col.getColor()) ;
	}
}
