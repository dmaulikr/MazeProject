...
public class MazeApplication extends JFrame {
	...
	public MazeApplication(String parameter) {
		super() ;
		if ("Prim".equalsIgnoreCase(parameter) || parameter.contains("-g Prim"))
		{
			System.out.println("MazeApplication: generating random maze with Prim's algorithm");
			maze = new Maze(1) ;
			init() ;
		}
		else if ("Kruskal".equalsIgnoreCase(parameter) || parameter.contains("-g Kruskal")){
		...
		if(parameter.contains("-d WallFollower") || parameter.contains("-d Wizard")){
			RobotDriver robotDriver;
			Robot robot = new BasicRobot();
			if(parameter.contains("-d WallFollower"))
